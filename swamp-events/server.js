...
// Middleware for GET /:id/timer endpoint

// Middleware for GET /:id/events endpoint
function eventsHandler(req, res, next) {
  ...
  const data = `data: { "userID": ${clientId}, "nests": ${JSON.stringify(nests)} }\n\n`;
  console.log(data)
  res.write(data);
...
function sendEventsToAll(newNest) {
  clients.forEach(c => c.res.write(`data: { "userID": ${c.id}, "nests": ${JSON.stringify(newNest)} }\n\n`))
}
